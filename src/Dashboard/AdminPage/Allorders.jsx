...
const Allorders = () => {
    ...
    // For admin view, we can use the same localStorage key or a different one
    // Since it's all users' orders, we'll use the same 'userOrders' key
    useEffect(() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-green-50 p-4 rounded-lg text-center">
                    <div className="text-2xl font-bold text-green-600">
                        ${allOrders.reduce((total, order) => total + (parseFloat(order.totalAmount) || 0), 0).toFixed(2)}
                    </div>
